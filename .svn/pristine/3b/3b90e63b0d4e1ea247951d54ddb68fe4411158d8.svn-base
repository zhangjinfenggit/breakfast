...
import com.hmw.open.common.pushmsg.JPushMsgTool;
...
public class MsmTool {
	...
	private static String accountSid = "8a48b551493ffbd4014950a920840a5f";
	
	private static String authToken = "f830ffa7c7364e0eba74d84a53a0ecb2";
	/*生产环境*/
